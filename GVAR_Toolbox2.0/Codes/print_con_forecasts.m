function print_con_forecasts(lastobs,fhorz,cnames_s_x,xnames,xforc,rx,outdir)

%**************************************************************************
% PURPOSE: printing conditional forecasts of GVAR
%--------------------------------------------------------------------------
% Meiling He, Nov 2012
...
tab = ['GVAR Conditional Forecasts' num2cell(NaN(1,2+cols(table)))];
...
xlswrite([outdir 'output.xlsx'],tab,'conditional forecasts');
